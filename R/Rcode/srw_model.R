...
title(ylab=expression(paste("Population growth rate"," ",(lambda[infinity]))),cex.lab=1.1)
title(xlab="Value of demographic rate",cex.lab=1.1)
...
plot(vr,sens$Sj, type='l', lwd=2, las=1,ylim=c(0.8,1.2),xlim=c(0.87,1),lty=2, col=3, cex=0.9,
     ylab="", xlab="")
title(main=expression(paste("Juvenile Survival"," " ,(sigma[j]))),cex.main=2.1)
title(ylab=expression(paste("Population growth rate"," ",(lambda[infinity]))),cex.lab=1.2)
title(xlab="Value of demographic rate",cex.lab=1.2)
abline(h = 1.056, col = "gray60")
...
plot(vr,sens$Sa, type='l', lwd=2, las=1,ylim=c(0.8,1.2),xlim=c(0.87,1),lty=5, col=3, cex=0.9,
     ylab="", xlab="")
title(main=expression(paste("Adult Survival"," " ,(sigma[a]))),cex.main=2.1)
title(ylab=expression(paste("Population growth rate"," ",(lambda[infinity]))),cex.lab=1.1)
title(xlab="Value of demographic rate",cex.lab=1.1)
abline(h = 1.056, col = "gray60")
abline(h = 0, v = 0.91,col = "red")
...
#abline(h = 0, v = 0, col = "gray60")
########Juvenile Transition################
plot(vr,sens$Tj,type='l', lwd=2, las=1,ylim=c(0.8,1.2),xlim=c(0.04,0.16),lty=4, col=65,
     cex=0.9,
     , ylab="", xlab="")
title(main=expression(paste("Juvenile Transition"," " ,(gamma[j]))),cex.main=2.1)
title(ylab=expression(paste("Population growth rate"," ",(lambda[infinity]))),cex.lab=1.1)
title(xlab="Value of demographic rate",cex.lab=1.1)
abline(h = 1.056, col = "gray60")
...
plot(vr,sens$Ma, type='l', lwd=2, las=1,ylim=c(0.8,1.2),lty=9, col=34, cex=0.9,
     ylab="",xlab="", main="",xlim=c(0.09,0.22))
title(main=expression(paste("Fecundity"," ","(Mx)")),cex.main=2.1)
title(ylab=expression(paste("Population growth rate"," ",(lambda[infinity]))),cex.lab=1.2)
title(xlab="Value of demographic rate",cex.lab=1.2)
abline(h = 1.056, col = "gray60")
